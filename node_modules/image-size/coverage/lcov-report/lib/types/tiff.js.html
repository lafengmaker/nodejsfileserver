...
<html lang="en">
<head>
    <title>Code coverage report for lib/types/tiff.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/types/tiff.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/types/</a> &#187; tiff.js</div>
</div>
<div class="body">
...
function nextTag (buffer) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (buffer.length &gt; 24) {
...
function determineEndianness (buffer) {
  ...
  if ('II' === signature) {
    return 'LE';
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if ('MM' === signature) {
    return 'BE';
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new TypeError('Invalid Tiff, missing tags');</span>
  }
&nbsp;
  return {
    'width': width,
