...
<html lang="en">
<head>
    <title>Code coverage report for lib/types/jpg.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/types/jpg.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">lib/types/</a> &#187; jpg.js</div>
</div>
<div class="body">
...
function validateBuffer (buffer, i) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (i &gt; buffer.length) {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('Corrupt JPG, exceeded buffer limits');</span>
  }
  // Every JPEG block must begin with a 0xFF
  <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer[i] !== 0xFF) {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('Invalid JPG, marker table corrupted');</span>
  }
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  throw new TypeError('Invalid JPG, no size found');</span>
}
&nbsp;
module.exports = {
  'detect': isJPG,
